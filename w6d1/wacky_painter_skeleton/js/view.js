...
View.prototype.exercise3 = function () {
  ...
  const h1El = $("<h1>i love jquery</h1>");
  $("body").append(h1El);
  //your code here!
};
...
View.prototype.exercise5 = function () {
  ...
  squares.on("click", event => {
    const curSquare = $(event.currentTarget);
    const square = curSquare.data("pos")
    console.log(square);
    alert(square);
  })
  //your code here!
...
View.prototype.exercise7 = function(){
  ...
  squares.on("mouseover", event =>{
    const curSquare = $(event.currentTarget);
    console.log(curSquare.css("background-color"));
